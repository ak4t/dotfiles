...
var t=e("table",w.tv_contents+" noborder","tv_content"+u);
g.appendChild(z);B.appendChild(g);m.appendChild(B);
f.appendChild(m);y.appendChild(f);l.appendChild(t);
x.appendChild(l);y.appendChild(x);q.appendChild(y);
n.appendChild(q);var r=function(F,G,E){if(G){F.setAttribute("style",E?b.staticVars.visible_move:b.staticVars.visible)
