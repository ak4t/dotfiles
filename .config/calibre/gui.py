...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt4.QtCoreq\x02U\nQByteArrayU.\x01\xd9\xd0\xcb\x00\x01\x00\x00\x00\x00\x01\x11\x00\x00\x00\x19\x00\x00\x06\x94\x00\x00\x03\xdd\x00\x00\x01\x13\x00\x00\x00,\x00\x00\x06\x92\x00\x00\x03\xd8\x00\x00\x00\x00\x00\x00\x85\x87Rq\x03.')
...
internally_viewed_formats = cPickle.loads('\x80\x02]q\x01.')
...
default_send_to_device_action = 'DeviceAction:main::False:True'
...
save_to_disk_template_history = cPickle.loads('\x80\x02]q\x01X)\x00\x00\x00{author_sort}/{title}/{title} - {authors}q\x02a.')
 
# send to device template history
# Previously used Send to Device templates
send_to_device_template_history = cPickle.loads('\x80\x02]q\x01(X*\x00\x00\x00{author_sort}/{series}/{title} - {authors}q\x02X!\x00\x00\x00{author_sort}/{title} - {authors}q\x03e.')
 
# main search history
# Search history for the main GUI
main_search_history = cPickle.loads('\x80\x02]q\x01(X\t\x00\x00\x00goldsteinq\x02X\x06\x00\x00\x00Martinq\x03X\x07\x00\x00\x00malazanq\x04X\x06\x00\x00\x00Wilderq\x05X\x17\x00\x00\x00author:"=Stieg Larsson"q\x06X\x07\x00\x00\x00larssonq\x07X\x06\x00\x00\x00dragonq\x08X\x1f\x00\x00\x00the girl with the dragon tattooq\tX\x08\x00\x00\x00the girlq\ne.')
...
plugin_search_history = cPickle.loads('\x80\x02]q\x01X\x05\x00\x00\x00dedrmq\x02a.')
...
overwrite_author_title_metadata = False
