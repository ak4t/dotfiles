...
# send template
# The template to control the filename and directory structure of files sent to the device. Default is "{author_sort}/{title} - {authors}" which will save books into a per-author directory with filenames containing title and author. Available controls are: {publisher, series_index, isbn, pubdate, rating, series, author_sort, authors, last_modified, timestamp, title, id, tags}
send_template = u'{author_sort}/{series}/{title} - {authors}'
